...
def backup_databases():
    ...
    redis_copy = subprocess.run(['sudo docker cp redis:/data/dump.rdb /home/ubuntu/Website-Deployment/redis-backups/dump.rdb'], shell=True, capture_output=True, text=True, check=True)
